    ...
    SingleChildScrollView(
      ...
      Center(child: Column(children: [
        ...
        Padding(
            ...
            child:  TextField(decoration:InputDecoration(labelText:"Enter Password " ,suffixIcon:IconButton(icon: Icon(pass ==true?Icons.visibility_off:pass==false?Icons.visibility:Icons.visibility), onPressed: () {setState(() {
              pass=!pass;
